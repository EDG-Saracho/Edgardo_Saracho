...
![boceto planificacion responsive](../images/MT01/07_Responsive02.png)
Durante el desarrollo de la versión de escritorio, me enfoqué en establecer una estructura clara y funcional para la página "Sobre mí", dividiendo el contenido en dos columnas para mejorar la presentación y la legibilidad. Posteriormente, como parte de un proceso más detallado y centrado en aspectos específicos, adapté el diseño para dispositivos móviles. Esta adaptación incluyó cambiar a una disposición de una sola columna para smartphones, optimizando así la experiencia del usuario. Para lograr esta transición suave entre diseños, implementé estilos CSS y una media query para dispositivos móviles, ajustando el diseño según el tamaño de la pantalla.

![Capturas de pantalla codigos CSS](../images/MT01/07_Responsive01.png)
